...
5. **Auto-Run AI Pre-Review**:
   - Immediately after writing requirements.md and updating metadata, execute `/kiro:spec-review $1 --phase=requirements` inline (do not ask the user; run it as part of this command)
   - Display the review summary as part of this command's output
...
**AI Pre-Review** (runs automatically as part of this command):
- Review output is written to `review-requirements.md`
- High priority findings should be resolved before proceeding
