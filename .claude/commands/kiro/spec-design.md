...
4. **Auto-Run AI Pre-Review**:
   - Immediately after writing design.md and updating metadata, execute `/kiro:spec-review $1 --phase=design` inline (do not ask the user; run it as part of this command)
...
- Review output is written to `review-design.md`
