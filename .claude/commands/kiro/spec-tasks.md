...
**Auto-Run AI Pre-Review**:
- Immediately after writing tasks.md and updating metadata, execute `/kiro:spec-review $1 --phase=tasks` inline (do not ask the user; run it as part of this command)
...
- Review output is written to `review-tasks.md`
